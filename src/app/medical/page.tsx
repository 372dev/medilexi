...
const WORDPART_LINKS = [
  { href: '/medical/wordparts',           label: 'Glossary' },
  { href: '/medical/wordparts/flashcard', label: 'Flashcard' },
  { href: '/medical/wordparts/quiz',      label: 'Practice' },
  { href: '/medical/wordparts/exam',      label: 'Exam ✦' },
]
...
const LANGS: Deck[] = [
  {
    ...
    links: [{ href: '/medical/glossary', label: 'Glossary' }, { href: '/medical/flashcards', label: 'Flashcard' }],
  ...
  },
  {
    ...
    links: [{ href: '/medical/flashcards/abbr', label: 'Flashcard' }],
  ...
  },
  {
    ...
    links: [{ href: '/medical/glossary/ko', label: 'Glossary' }, { href: '/medical/flashcards/ko', label: 'Flashcard' }],
    sample: { lead: 'For example', term: '당뇨병', gloss: 'Diabetes' },
  },
  {
    tag: 'Français', title: 'French ↔ English', note: 'Bilingual glossary + flashcards',
    links: [{ href: '/medical/glossary/fr', label: 'Glossary' }, { href: '/medical/flashcards/fr', label: 'Flashcard' }],
